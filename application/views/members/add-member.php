				...
				<div class="card-body">				
						<div class="row">
								...
								<div class="col-12  col-md-6">
									...
									<input type="password"  class="form-control" placeholder="Enter Password" ng-model="member.passwordBy">
								</div>
								<div class="col-12 col-md-6">
									<label>Name</label>
								...
								<div class="col-12  col-md-3 pt-4">
										...
										<button ng-click='addMember()' type="button" class="btn btn-success">Add member</button>
								</div>
