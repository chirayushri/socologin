<title>Update Page <?=$this->session->userdata('logged_user')['name']?>- Welcome in App</title>
				...
				<div class="card-body">				
						<div class="row">
								<div class="col-12 col-md-6">
									...
									<input type="hidden"  id="param4" value="<?=$param1?>">
								</div>
								...
								<div class="col-12  col-md-3 pt-4">
										...
										<button ng-click='savePage()' type="button" class="btn btn-success">Save</button>
